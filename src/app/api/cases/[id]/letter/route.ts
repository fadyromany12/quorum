...
import { winAnsi as safe } from "@/lib/pdf-text.js";
...
async function renderLetter(m: Model): Promise<Uint8Array> {
  ...
  // Footer
  y = M - 8;
  for (const ln of wrap(`${m.lawCitation}. This notice is a system-of-record document generated by ${BRAND.name}.`, font, 8, width)) {
