...
const DICT = {
  en: {
    ...
    "login.newJoiner": "Just joined?",
    "login.signUp": "Fill in your details",
    "login.pending": "Your account is waiting for your manager to approve it. Your password is fine — there is nothing to fix here, and you will be able to sign in once they have.",
    "login.deactivated": "This account has been deactivated. Your password is correct; ask HR to reinstate the account.",
  ...
  ar: {
    ...
    "login.newJoiner": "التحقت حديثًا؟",
    "login.signUp": "أدخل بياناتك",
    "login.pending": "حسابك في انتظار موافقة مديرك. كلمة المرور صحيحة ولا يوجد ما يستدعي تغييرها — ستتمكن من الدخول بمجرد الموافقة.",
    "login.deactivated": "تم إيقاف هذا الحساب. كلمة المرور صحيحة؛ تواصل مع الموارد البشرية لإعادة تفعيله.",
