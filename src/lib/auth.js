...
export const TABS_FOR = {
  ...
  SuperAdmin: [
    ...
    "helpdesk", "matrix", "users", "settings", "notifications",
  ],
  ...
  WFM: ["wfm", "floor", "exceptions", "rta", "notifications"],
  ProjectManager: ["dashboard", "joining", "floor", "exceptions", "requests", "log", "wfm", "triage", "agents", "leaving", "people", "roster", "insights", "notifications"],
  OperationsLead: ["dashboard", "joining", "floor", "exceptions", "requests", "approvals", "wfm", "agents", "leaving", "people", "roster", "insights", "notifications"],
  ...
  HRBusinessPartner: [
    ...
    "triage", "agents", "leaving", "people", "roster", "insights", "audit", "notifications",
  ],
  ...
  ITSupport: ["helpdesk", "notifications"],
  Agent: [],
};
